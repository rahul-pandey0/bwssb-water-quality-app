...
class WtpReportDetailScreenPublic extends StatefulWidget {
  final String wtpName;
  final String sampleDate;

  const WtpReportDetailScreenPublic({
    super.key,
  ...
  @override
  State<WtpReportDetailScreenPublic> createState() =>
      _WtpReportDetailScreenState();
}

class _WtpReportDetailScreenState extends State<WtpReportDetailScreenPublic> {
  bool loading = true;
  List<dynamic> sample = [];
