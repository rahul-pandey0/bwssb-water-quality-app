...
import 'service_station_report_detail_screen.dart';
import '../widgets/wqms_app_bar.dart';
import '../widgets/page_heading.dart';

class ServiceStationReportScreen extends StatefulWidget {
  const ServiceStationReportScreen({super.key});

  @override
  State<ServiceStationReportScreen> createState() =>
      _ServiceStationReportScreenState();
}

class _ServiceStationReportScreenState
    extends State<ServiceStationReportScreen> {
  DateTime? startDate;
  DateTime? endDate;
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (_) => ServiceStationReportDetailScreen(
