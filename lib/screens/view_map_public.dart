...
class ViewMapPublic extends StatefulWidget {
  const ViewMapPublic({super.key});

  @override
  State<ViewMapPublic> createState() => _ViewMapPublicState();
}

class _ViewMapPublicState extends State<ViewMapPublic> {
  bool loading = true;
